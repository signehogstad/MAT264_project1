function [Y,t] = euler_forward_ssb(funcs, init_vals, h, t_start, t_end)
...
for i = 1:n
    ...
    for k = (length(init_vals)/2+1):length(init_vals)
        Y(i+1,k) = Y(i,k) + h*funcs{k}(Y(i,1),Y(i,2),Y(i,3),Y(i,4),Y(i,5),Y(i,6),Y(i,7),Y(i,8),Y(i,9),Y(i,10),Y(i,11),Y(i,12),Y(i,13),Y(i,14),Y(i,15),Y(i,16),Y(i,17),Y(i,18),Y(i,19),Y(i,20),Y(i,21),Y(i,22),Y(i,23),Y(i,24),Y(i,25),Y(i,26),Y(i,27),Y(i,28),Y(i,29),Y(i,30));
    end
